...
def detect_provider_type(base_url: str) -> str:
    ...
    if not base_url:
        return "unknown"
    if base_url.startswith("elevenlabs://") or "elevenlabs.io" in base_url:
        return "elevenlabs"
            ...
            for url in TTS_BASE_URLS:
                ...
                if provider_type == "elevenlabs":
                    self.registry["tts"][url] = EndpointInfo(
                        base_url=url,
                        models=["eleven_flash_v2_5", "eleven_v3", "eleven_multilingual_v2", "eleven_turbo_v2_5", "eleven_flash_v2"],
